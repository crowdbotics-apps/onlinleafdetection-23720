"""onlinleafdetection_23720 URL Configuration
...
admin.site.site_header = "OnlinLeafDetection"
admin.site.site_title = "OnlinLeafDetection Admin Portal"
admin.site.index_title = "OnlinLeafDetection Admin"

# swagger
api_info = openapi.Info(
    title="OnlinLeafDetection API",
    default_version="v1",
    description="API documentation for OnlinLeafDetection App",
)
